(function () {
    ...
    function component(object) {
      ...
      this.append = function (element) {
        ...
        // Add title to card after render
        setTimeout(function() {
          var lineElement = item.render();

          // Get title from element data
          var titleText = element.title || element.name || element.original_title || element.original_name || '';

          if (titleText) {
            // Find all cards and add title to each
            lineElement.find('.card--small, .card').each(function() {
              var card = $(this);
